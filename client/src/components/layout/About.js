    ...
    <Fragment>
        ...
        <div className="container h-100">
          <div className="row h-100 align-items-center">
            <div className="col-md-12 text-center">
              <h1><strong>Welcome to Red Bus Travels</strong></h1>
              <p>
        ...
        <div className="container text-center">
          ...
          <div className="container">
            ...
            <div className="col-md-12">
              <p>https://www.facebook.com/redbus</p>

              <p>https://www.instagram.com/redbus</p>

              <p>https://www.google.com/redbus</p>

              <p>https://www.twitter.com/redbus</p>
      ...
      <section className="footer bg-dark">
        <div className="container py-5 text-white text-center">
          <p>Copyright © 2021 - RedBus Pvt Ltd.</p>
        </div>
      </section>
